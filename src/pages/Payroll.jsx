...
const PayrollModule = () => {
  ...
  async function fetchData() {
    try {
      const url = "http://hrmbackend.teqova.biz/api/payroll";
  ...
  const handleUpdate = async (e) => {
    try {
      ...
      const url = "http://hrmbackend.teqova.biz/api/updatepayroll";
  ...
  const handleProcessPayment = async () => {
    ...
    if (paymentType === "mass") {
      ...
      try {
        const response = await fetch('http://hrmbackend.teqova.biz/api/processbulkpayroll');
        const data = await response.json();
...
export async function loader() {
  ...
  const url2 = "http://hrmbackend.teqova.biz/api/payroll";
